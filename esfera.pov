...
//Avance del reloj
#declare avance=2*clock;
//Para salvar el avance del reloj.

//Valor de radio
#declare radio=.5;


#declare pos_x=avance;
#declare pos_y=avance;

//Verificar el avance
#if (avance+radio<1)
	//Posición de y
	#declare pos_z=avance;
//De lo contrario
#else
	#declare pos_z=1-radio;
//Terminar if
#end
